...
<%=request.getParameter("id")%>
	...
	function upload_data() {
		...
		var param = "title=" + title + "&intro=" + intro + "&content="
	...
	<form>
		<table class="common">
			<tbody>
				<tr>
					<th class='bg'>标题：</th>
					<td><input type="text" id="title" style="width: 500px;"></input></td>
				</tr>

				<tr>
					<th class='bg'>作者：</th>
					<td><input type="text" id="author" value='管理员'></input></td>
				</tr>
				<tr>
					<th class='bg'>是否发布：</th>
				...
				<tr>
					...
					<td><textarea id="intro" name="intro"
							style="width: 700px; height: 50px" rows="2" cols=""></textarea></td>
				</tr>
				<tr>
					<th class='bg'>内容：</th>
					<td><textarea id="content" name="content"
							style="width: 700px; height: 350px" rows="10" cols=""></textarea></td>
				</tr>
			</tbody>
		</table>
